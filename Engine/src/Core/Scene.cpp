...
Layer::Layer(std::string name, std::string tileset, const std::vector<double> &data)
...
std::string_view Layer::GetTileset() const {
  return tileset_;
}

void Layer::SetTileset(const std::string &tileset) {
  tileset_ = tileset;
}

const std::vector<double> &Layer::GetData() const {
  return data_;
}

void Layer::SetData(const std::vector<double> &data) {
  data_ = data;
}
...
Tileset::Tileset(std::string name, int image_width, int image_height, int tile_width, int tile_height)
    : name_(std::move(
    name)),
...
std::string_view Tileset::GetName() const {
  return name_;
}
...
void Tileset::SetImageWidth(int image_width) {
  image_width_ = image_width;
}
int Tileset::GetImageHeight() const {
  return image_height_;
}
void Tileset::SetImageHeight(int image_height) {
  image_height_ = image_height;
}
...
Scene::Scene(int canvas_width, int canvas_height) : canvas_width_(canvas_width), canvas_height_(canvas_height) {}
Scene::Scene(const std::vector<Layer> &layers,
             const std::vector<Tileset> &tile_sets,
             int canvas_width,
             int canvas_height)
    : layers_(layers), tile_sets_(tile_sets), canvas_width_(canvas_width), canvas_height_(canvas_height) {}
const std::vector<Layer> &Scene::GetLayers() const {
  return layers_;
}
void Scene::SetLayers(const std::vector<Layer> &layers) {
  layers_ = layers;
}
const std::vector<Tileset> &Scene::GetTileSets() const {
  return tile_sets_;
}
void Scene::SetTileSets(const std::vector<Tileset> &tile_sets) {
  tile_sets_ = tile_sets;
}
int Scene::GetCanvasWidth() const {
  return canvas_width_;
}
void Scene::SetCanvasWidth(int canvas_width) {
  canvas_width_ = canvas_width;
}
int Scene::GetCanvasHeight() const {
...
struct adl_serializer<CSPill::EngineCore::Tileset> {
  static CSPill::EngineCore::Tileset from_json(const json &j) {
    return {j.at("name"), j.at("imagewidth"), j.at("imageheight"), j.at("tilewidth"), j.at("tileheight")};
  }
...
struct adl_serializer<CSPill::EngineCore::Scene> {
  static CSPill::EngineCore::Scene from_json(const json &j) {
    return {j.at("layers"), j.at("tilesets"),
