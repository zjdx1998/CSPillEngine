...
void PB_TransformComponent(py::module &m) {
  py::class_<TransformComponent, Component>(m, "TransformComponent")
      ...
      .def("position", &TransformComponent::position, "Get position", py::return_value_policy::reference)
      .def("velocity", &TransformComponent::velocity, "Get velocity", py::return_value_policy::reference);
}
