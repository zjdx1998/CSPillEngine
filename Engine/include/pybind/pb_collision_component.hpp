...
void PB_CollisionComponent(py::module &m) {
  py::class_<CollisionComponent, Component>(m, "CollisionComponent")
      ...
      .def_property("bouding_box", &CollisionComponent::GetBoundingBox, &CollisionComponent::SetBoundingBox)
      .def_property("callback",
                    &CollisionComponent::GetCallback,
                    &CollisionComponent::SetCallback,
                    "Get/Set Call Back Function.")
      .def("Register", &CollisionComponent::Register, "Register a GameObject into collision events listener.")
      .def("UnRegister", &CollisionComponent::UnRegister, "UnRegister a GameObject from collision event listeners.")
      .def_static("Collide", &CollisionComponent::Collide, "Check if two FRect overlapped or not.");
}
