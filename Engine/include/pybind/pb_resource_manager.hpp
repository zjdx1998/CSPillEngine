...
void PB_ResourceManager(py::module &m) {
  py::class_<ResourceManager>(m, "ResourceManager",
                              "Resource Manager for both engine and game.")
      .def_static("GetInstance", &ResourceManager::GetInstance,
                  py::return_value_policy::reference,
                  "GetInstance will return the reference to ResourceManager "
                  "object if it is created."
                  "Otherwise, create the object and return.")
      .def("LoadResources", &ResourceManager::LoadResources,
           "LoadResources takes a folder path as an argument and load all "
      ...
      .def("LoadScene", &ResourceManager::LoadScene,
           py::return_value_policy::reference,
           "Search for the tile map resource by scene_name.")
      ...
      .def(
          "SetRenderer",
          [](ResourceManager &self, void *renderer) {
