 ...
 */
  ...
  public:
     ...
     * @param bkg_color SDL_Color of the layer, the default value is 255, 255, 255, 255
     */
    ...
    */
     ...
     * @param background_color SDL_Color which represents the target background color
     */
 ...
 */
   ...
   *
   * A scene object contains of list of layers and Tilesets. It is an object that can
   * be loaded to ResourceManager.
   */
  class Scene {
  public:
    /**
     ...
     * @param tile_sets a vector, which represents a target list of Tileset objects
     */
     ...
     * @param accumulate bool, determine if it accumulate render, default to be false
